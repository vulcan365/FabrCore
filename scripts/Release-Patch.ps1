...
if ($DryRun) {
    Write-Host "[DryRun] Would create and push tag $newTag and generate GitHub release notes for all FabrCore packages, including FabrCore.Surface." -ForegroundColor Yellow
    exit 0
}
