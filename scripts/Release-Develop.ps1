...
if ($DryRun) {
    ...
    Write-Host '[DryRun] Release package set includes FabrCore.Core, FabrCore.Sdk, FabrCore.Client.Orleans, FabrCore.Host, FabrCore.Host.SqlServer, FabrCore.Host.AzureStorage, FabrCore.Services.Microsoft365Copilot.' -ForegroundColor Yellow
    exit 0
}
...
Write-Host 'Release package set includes FabrCore.Core, FabrCore.Sdk, FabrCore.Client.Orleans, FabrCore.Host, FabrCore.Host.SqlServer, FabrCore.Host.AzureStorage, FabrCore.Services.Microsoft365Copilot.' -ForegroundColor Green
