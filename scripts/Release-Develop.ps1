...
if ($DryRun) {
    ...
    Write-Host '[DryRun] Release package set includes runtime, host providers, Microsoft 365 Copilot, Services.Contracts, Memory, GraphRag, and Surface.' -ForegroundColor Yellow
    exit 0
}
...
Write-Host 'Release package set includes runtime, host providers, Microsoft 365 Copilot, Services.Contracts, Memory, GraphRag, and Surface.' -ForegroundColor Green
