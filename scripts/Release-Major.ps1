...
Write-Host "Packages: FabrCore.Core, FabrCore.Sdk, FabrCore.Client.Orleans, FabrCore.Host, FabrCore.Host.SqlServer, FabrCore.Host.AzureStorage, FabrCore.Services.Microsoft365Copilot"
