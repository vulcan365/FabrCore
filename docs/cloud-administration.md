...
The existing [outbound connection protocol](cloud-server-protocol.md) carries
...
Provision the additive [SQL migration](migrations/monitoring.sql) before enabling
