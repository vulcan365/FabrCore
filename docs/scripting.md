...
The [SampleApp scripting demo](../samples/FabrCore.SampleApp/README.md#try-c-scripting) exposes a
...
Run the [console sample](../samples/FabrCore.Scripting.Sample/Program.cs) without a model/API key:
