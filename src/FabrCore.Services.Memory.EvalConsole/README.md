...
[the experiment record](../../docs/evals/memory-selection-experiment.md) for measured savings and limits.
...
candidate only. See [verification results](../../docs/evals/memory-selection-verification-experiment.md).

## Existing tests

`multi-chunk --iterations 3 --header-mode rich|opaque --matched-chunks true` compares primary
and query-matched preview/body loading and checks chunk provenance. See [matched chunk results](../../docs/evals/memory-matched-chunks-experiment.md).

`multi-chunk --iterations 3` stores facts in chunk 1 behind a generic primary chunk and
scores selected IDs separately from loaded body evidence. See [multi-chunk results](../../docs/evals/memory-multi-chunk-experiment.md).

`body-position --iterations 3` compares 0-, 160- and 256-character previews with the fact
beginning at body offset 145 and a long trailing section. See [positional results](../../docs/evals/memory-body-position-experiment.md).
...
to measure overhead where headers already suffice. See [preview results](../../docs/evals/memory-selection-preview-experiment.md).
...
bodies and embedding inputs are retained. See [sparse-header experiment](../../docs/evals/memory-sparse-headers-experiment.md).
...
See [hybrid experiment](../../docs/evals/memory-hybrid-candidates-experiment.md).
...
candidate-coverage diagnostics. See [same-type experiment](../../docs/evals/memory-same-type-experiment.md).
...
to eight. See [candidate-diversity results](../../docs/evals/memory-diverse-candidates-experiment.md).
...
checks include separate candidate-coverage diagnostics. See [correction results](../../docs/evals/memory-correction-experiment.md).
...
See [long-history results and limitations](../../docs/evals/memory-long-history-experiment.md).
...
See [chunk coverage results](../../docs/evals/memory-chunk-coverage-experiment.md).
...
See [bounded chunk results](../../docs/evals/memory-bounded-chunks-experiment.md).
...
above one. See [selective chunk results](../../docs/evals/memory-selective-chunks-experiment.md).
...
for that multi-chunk fixture. See [shortcut results](../../docs/evals/memory-redundant-selection-experiment.md).
...
selection enabled. See [chunk preview results](../../docs/evals/memory-chunk-preview-experiment.md).
...
experiment; all controls are retained. See [late-correction results](../../docs/evals/memory-late-correction-experiment.md).
...
true` with chunk selection and a preview length of at least two. See [split-window results](../../docs/evals/memory-chunk-windows-experiment.md).
