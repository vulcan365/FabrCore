...
public static partial class SurfaceSwarmSquadHandleBuilder
{
    ...
    public static string BuildSupervisorAlias(string squadSlug)
        => $"{BuildOrchestratorAlias(squadSlug)}-supervisor";

    public static string BuildVerifierAlias(string squadSlug)
        => $"{BuildOrchestratorAlias(squadSlug)}-verifier";
