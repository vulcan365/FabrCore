...
the recent-header cap while excluding cold memories. See [the measured experiment and limits](../../../docs/evals/memory-long-history-experiment.md).
...
of facts. It adds no model calls. See [the experiment and tradeoffs](../../../docs/evals/memory-diverse-candidates-experiment.md).
...
and remains opt-in. See [hybrid allocation](../../../docs/evals/memory-hybrid-candidates-experiment.md).
...
need no preview. See [quality and token-cost results](../../../docs/evals/memory-selection-preview-experiment.md).
...
and update APIs keep their existing semantics. See [matched-chunk evaluation](../../../docs/evals/memory-matched-chunks-experiment.md).
...
See [multi-chunk coverage and context costs](../../../docs/evals/memory-bounded-chunks-experiment.md).
...
See [selective chunk evaluation](../../../docs/evals/memory-selective-chunks-experiment.md).
...
See [redundant selection experiment](../../../docs/evals/memory-redundant-selection-experiment.md).
...
evaluation](../../../docs/evals/memory-chunk-preview-experiment.md).
...
The tail is not necessarily the end of a longer stored chunk. See [split-window evaluation](../../../docs/evals/memory-chunk-windows-experiment.md).
