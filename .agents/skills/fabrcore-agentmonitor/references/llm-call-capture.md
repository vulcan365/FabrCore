...
|-------|--------|-------|--------------|---------------|
| Messages | `_messages` | `GetMessagesAsync` | `OnMessageRecorded` | `AgentGrain.OnMessage` (inbound + outbound), `AgentGrain.ReceivedChatMessage` (system messages), `PrincipalGrain.OnMessageStream` |
